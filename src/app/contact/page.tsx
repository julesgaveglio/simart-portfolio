...
export default function Contact() {
  ...
  return (
    <div className="pt-24 px-8 pb-16 max-w-6xl mx-auto">
      <h1 className="text-2xl mb-8">{t('contact.pageTitle')}</h1>
      ...
      <div className="flex flex-col md:flex-row gap-12">
        ...
        <div className="w-full md:w-1/2">
          ...
          <div className="space-y-6 mb-8">
            <div>
              ...
              <p className="text-sm">info@simoneroodeselaar.com</p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm">{t('contact.studioAddress')}</p>
              <p className="text-sm italic mt-1">{t('contact.openingHours')}</p>
            </div>
          </div>
        ...
        <div className="w-full md:w-1/2 mt-8 md:mt-0">
          <h2 className="text-lg font-medium mb-6">{t('contact.formTitle')}</h2>
